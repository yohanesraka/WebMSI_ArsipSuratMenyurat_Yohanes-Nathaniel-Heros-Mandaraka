					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300"><img src="assets/logo.jpg" alt="Logo Surat Menyurat" width="100"></div>
								<h5 class="content-group">Pengarsipan Surat <small class="display-block">Silahkan Masuk</small></h5>
								<?php
